    ...
    'config' => [
        ...
        'columns-config' => [
            ...
            'xxl' => [
                ...
                'column-class' => 'col-xxl-%d',
                'offset-class' => 'offset-xxl-%d',
                'push-class' => 'push-xxl-%d',
                'pull-class' => 'pull-xxl-%d',
                'hide-class' => 'd-xxl-none',
            ],
        ],
        'additional-classes' => [
...
$GLOBALS['DMA_SIMPLEGRID_CONFIG']['gr-grid'] = [
    'name' => 'Twitter Bootstrap (with GRgrid)',
    'config' => [
        'hasRows' => true,
        'hasColumns' => true,
        'hasColumnOffset' => true,
        ...
        'columns-config' => [
            ...
            'xxl' => [
                'name' => 'extra extra large',
                'column-class' => 'col-xxl-%s',
                'offset-class' => 'col-xxl-offset-%s',
                'push-class' => 'col-xxl-push-%s',
                'pull-class' => 'col-xxl-pull-%d',
            ],
        ],
    ],
];
