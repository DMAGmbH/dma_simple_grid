 ...
 * Add to palette
 */
$GLOBALS['TL_DCA']['tl_settings']['palettes']['default'] .= ';{dma_simplegrid_legend},dmaSimpleGridType,dmaSimpleGrid_useColumns,dmaSimpleGrid_useOffset,dmaSimpleGrid_usePush,dmaSimpleGrid_usePull';
